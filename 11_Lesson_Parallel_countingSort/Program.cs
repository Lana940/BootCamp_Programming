...
int[] resSerial = new int[N].Select(r => rand.Next(0, 5)).ToArray();//копия массива для послед сортировки
int[] resParallel = new int[N]; //копия массива для парал сортировки
